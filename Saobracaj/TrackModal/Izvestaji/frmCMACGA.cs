...
{
    public partial class frmCMACGA : Form
    {
        public frmCMACGA()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            InsertCMACGA ins = new InsertCMACGA();
            ins.DelOtprem();
            ...
            ins.InsOtpremNajava(Convert.ToDateTime(dtpDatumOd.Value), Convert.ToDateTime(dtpDatumDo.Value));


            var select = "SELECT *  FROM [dbo].[repCMA] ";
