...
{
    class InsertVrstePostupakaUvoz
    {
        ...
        public void InsVrstePostupakaUvoz(string Naziv)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "InsertVrstePostupakaUvoz";
        ...
        public void UpdVrstePostupakaUvoz(int ID, string Naziv)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "UpdateVrstePostupakaUvoz";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DelVrstePostupakaUvoz(int ID)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "DeleteVrstePostupakaUvoz";
            cmd.CommandType = CommandType.StoredProcedure;
