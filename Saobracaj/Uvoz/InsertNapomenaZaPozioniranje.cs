...
namespace Saobracaj.Uvoz
{
    class InsertNapomenaZaPozioniranje
    {
        ...
        public void InsNapomenaZaPozicioniranje(string Naziv)
        {
            ...
            cmd.CommandText = "InsertNapomenaZaPozicioniranje";
        ...
        public void UpdNapomenaZaPozicioniranje(int ID, string Naziv)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "UpdateNapomenaZaPozicioniranje";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DelNapomenaZaPozicioniranje(int ID)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "DeleteNapomenaZaPozicioniranje";
            cmd.CommandType = CommandType.StoredProcedure;
