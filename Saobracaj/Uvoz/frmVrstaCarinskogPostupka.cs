...
namespace Saobracaj.Uvoz
{
    public partial class frmVrstaCarinskogPostupka : Form
    {
        ...
        private void FillGV()
        {
            var select = "Select * From VrstaCarinskogPostupka order by ID desc";
        ...
        private void tsSave_Click(object sender, EventArgs e)
        {
            ...
            {
                ins.UpdVrstaCarinskogPostupka(Convert.ToInt32(txtID.Text), txtNaziv.Text.ToString().TrimEnd(), txtOznaka.Text.ToString().TrimEnd());
            }
            FillGV();
            tsNew.Enabled = true;
            status = false;
        ...
        {
            InsertVrstaCarinskogPostupka ins = new InsertVrstaCarinskogPostupka();
            ins.DelVrstaCarinskogPostupka(Convert.ToInt32(txtID.Text));
            FillGV();
        }
