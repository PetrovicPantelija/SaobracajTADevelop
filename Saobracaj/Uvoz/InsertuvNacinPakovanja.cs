...
namespace Saobracaj.Uvoz
{
    class InsertuvNacinPakovanja
    {
        ...
        public void InsuvNacinPakovanja(string Naziv, string Oznaka)
        {
        ...
        public void UpduvNacinPakovanja(int ID, string Naziv, string Oznaka)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "UpdateuvNacinPakovanja";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DeluvNacinPakovanja(int ID)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "DeleteuvNacinPakovanja";
            cmd.CommandType = CommandType.StoredProcedure;
