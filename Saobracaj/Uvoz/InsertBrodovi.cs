...
namespace Saobracaj.Uvoz
{
    class InsertBrodovi
    {
        ...
        public void InsBrodovi(string Naziv,string Oznaka)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "InsertBrodovi";
        ...
        public void UpdBrodovi(int ID,string Naziv, string Oznaka)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "UpdateBrodovi";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DelBrodovi(int ID)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "DeleteBrodovi";
            cmd.CommandType = CommandType.StoredProcedure;
