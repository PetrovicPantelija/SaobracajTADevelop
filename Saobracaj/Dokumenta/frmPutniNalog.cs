...
namespace TrackModal.Dokumeta
{
  ...
  " FROM [dbo].[PutniNalogKvarovi]" +
        ...
        private void toolStripLabel1_Click(object sender, EventArgs e)
        {
            ...
            Saobracaj.TrackModal.TestiranjeDataSet14.SelectPutniNalogTransportDataTable dt = new Saobracaj.TrackModal.TestiranjeDataSet14.SelectPutniNalogTransportDataTable();
