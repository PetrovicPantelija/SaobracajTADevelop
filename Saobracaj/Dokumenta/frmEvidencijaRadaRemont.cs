...
{
    public partial class frmEvidencijaRadaRemont : Form
    {
        MailMessage mailMessage;
        Boolean status = false;

        public frmEvidencijaRadaRemont()
        {
            InitializeComponent();
        }

        public frmEvidencijaRadaRemont(int Sifra)
        {
            InitializeComponent();
        ...
        private void frmEvidencijaRada_Load(object sender, EventArgs e)
        {
            ...
            var select4 = " select ID, Naziv from VrstaAktivnosti where ObracunPoSatu = 1 and Remont = 1";
        ...
        {
            var select = "  select ID, Naziv from VrstaAktivnosti where ObracunPoSatu=1 and Remont = 1";
