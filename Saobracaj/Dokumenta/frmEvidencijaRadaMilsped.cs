...
{
    public partial class frmEvidencijaRadaMilsped : Form
    {
        MailMessage mailMessage;
        Boolean status = false;

        public frmEvidencijaRadaMilsped()
        {
            InitializeComponent();
        }

        public frmEvidencijaRadaMilsped(int Sifra)
        {
            InitializeComponent();
        ...
        private void frmEvidencijaRada_Load(object sender, EventArgs e)
        {
            ...
            var select4 = " select ID, Naziv from VrstaAktivnosti where ObracunPoSatu = 1";
        ...
        {
            var select = "  select ID, Naziv from VrstaAktivnosti where ObracunPoSatu=0";
