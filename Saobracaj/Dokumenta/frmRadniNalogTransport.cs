    ...
    public partial class frmRadniNalogTransport : Form
    {
     ...
     " ,[Potpisao]  FROM[dbo].[RadniNalogTransportStavke] IdNadredjenog = " + txtSifra.Text + " order by RB";
        ...
        private void toolStripLabel1_Click(object sender, EventArgs e)
        {
            ...
            Saobracaj.TrackModal.TestiranjeDataSet12.SelectRadniNalogTransportDataTable dt = new Saobracaj.TrackModal.TestiranjeDataSet12.SelectRadniNalogTransportDataTable();
            ...
            Saobracaj.TrackModal.TestiranjeDataSet13.SelectRadniNalogTransportStavkeDataTable dtl = new Saobracaj.TrackModal.TestiranjeDataSet13.SelectRadniNalogTransportStavkeDataTable();
