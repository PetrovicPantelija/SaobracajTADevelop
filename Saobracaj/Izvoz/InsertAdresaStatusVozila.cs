...
namespace Saobracaj.Izvoz
{
    ...
    class InsertAdresaStatusVozila
    {
        ...
        public void InsAdresaStatusVozila(string Naziv)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "InsertAdresaStatusVozila";
        ...
        public void UpdAdresaStatusVozila(int ID, string Naziv)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "UpdateAdresaStatusVozila";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DelAdresaStatusVozila(int ID)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "DeleteAdresaStatusVozila";
            cmd.CommandType = CommandType.StoredProcedure;
